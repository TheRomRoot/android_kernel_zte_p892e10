...
BOARD_BLUETOOTH_BDROID_BUILDCFG_INCLUDE_DIR := device/zte/bapex2/bluetooth
...
TARGET_BOOTLOADER_BOARD_NAME := bapex2
TARGET_BOARD_INFO_FILE := device/zte/bapex2/board-info.txt
BOARD_VENDOR_QCOM_GPS_LOC_API_HARDWARE := $(TARGET_BOARD_PLATFORM)
TARGET_NO_RPC := true

BOARD_EGL_CFG := device/zte/bapex2/egl.cfg
...
TARGET_RECOVERY_UI_LIB := librecovery_ui_bapex2
TARGET_RECOVERY_FSTAB = device/zte/bapex2/fstab.bapex2
